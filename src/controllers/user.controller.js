...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            $lookup: {
                from: "Subscritpion",     // Subscritpion is a model like User model and each model whole name is converted into lowercase and at the end of the name 's' is joined ex: Subscritpion is stored like subscritpions in database.
                localField: "_id",
